...
import JalilPropiedadesProject from '../assets/images/JalilPropiedadesProject.png';
...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    color: '#060010',
    title: 'Tecnologías',
    description: 'NextJs, TailwindCSS, Supabase',
    label: 'Inmobiliaria - Jalil Propiedades',
    altImg: JalilPropiedadesProject.src,
    srcImg: JalilPropiedadesProject.src,
  },
  {
    color: '#060010',
    title: 'Automation',
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className='bento-section relative grid w-full gap-2 p-3 select-none'
              ...
              return (
                ...
                >
                  <div className='card__header relative flex justify-between gap-3 text-white'>
                    <span className='card__label text-4xl font-bold'>{card.label}</span>
                  </div>
                  <div className='card__content relative flex flex-col text-white'>
                    <h3
                      className={`card__title m-0 mb-1 text-2xl font-medium ${textAutoHide ? 'text-clamp-1' : ''}`}
                    >
                      {card.title}
                    </h3>
                    <p
                  ...
                  {card.srcImg && (
                    <picture className='pointer-events-none absolute top-0 left-0 h-full w-full'>
                      <img
                        src={card.srcImg}
                        alt={card.altImg || ''}
