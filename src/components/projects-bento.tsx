...
const features = [
    {
        ...
        background: (
            <div className="absolute top-10 mask-[linear-gradient(to_top,transparent_40%,#000_100%)] [--duration:20s]"></div>
        ),
        // background: (
        //     <Marquee
        //         pauseOnHover
    ...
    },
    {
        ...
        // ),
        background: (
            <div className="absolute top-10 mask-[linear-gradient(to_top,transparent_40%,#000_100%)] [--duration:20s]" />
        ),
    },
    {
        Icon: Share2Icon,
